...
public class AccountBean {
	...
	public AccountBean(int accountId, double balance,
			CustomerBean customerBean, Date dateOfOpening,
			double initialDeposit, List<WalletTransaction> allTransactions) {
		super();
		this.accountId = accountId;
		this.balance = balance;
		this.customerBean = customerBean;
